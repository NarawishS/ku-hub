    ...
    def get(self, request, *args, **kwargs):
        ...
        for blog in blogs:
            if keyword.lower() in blog.title.lower() \
                    ...
                    or keyword.lower() in str(blog.author.username).lower()\
                    or keyword.lower() in str(blog.author.first_name).lower()\
                    or keyword.lower() in str(blog.author.last_name).lower()\
                    or keyword.lower() in str(blog.author.email).lower()\
                    or keyword.lower() in str(blog.author.profile.display_name).lower():
